...
function renderPublications(filter = "all") {
  ...
  $("#pub-list").innerHTML = rows.map((p, index) => {
    const doiOrStatus = p.doi
      ...
      : `<p class="doi-line"><b>Status:</b> In press / DOI not assigned yet</p>`;
